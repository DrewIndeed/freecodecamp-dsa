...
function updateRecords(records, id, prop, value) {
  // prop is not tracks - value is not empty -> records.id[prop] = value
  // prop is tracks - value is not empty - > records.id['tracks'].push(value)
  // prop is tracks - records.id not have tracks -> records.id[tracks] = []
  // value is empty -> delele records.id[prop]
  if (value !== '') {
    if (prop === 'tracks') {
